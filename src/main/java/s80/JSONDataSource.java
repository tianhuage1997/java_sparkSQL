...
public class JSONDataSource {
    ...
    public static void main(String[] args) {
        ...
        DataFrame goodStudentScoresDF = sqlContext.sql("select name ,score  from students where score>=80");
        ...
        JavaRDD<Row> goodStudentRowRDD =goodStudentsRDD.map(new Function<Tuple2< String, Tuple2<Integer, Integer> >, Row>() {
            ...
            public Row call(Tuple2<String, Tuple2<Integer, Integer>> tuple) throws Exception {
                ...
                Row result = RowFactory.create(tuple._1,tuple._2._1,tuple._2._2);
        ...
        DataFrame goodStudentsDF = sqlContext.createDataFrame(goodStudentRowRDD,structType);

        // 将好学生的全部信息保存到一个json文件中去
        // （将DataFrame中的数据保存到外部的json文件中去）
        goodStudentsDF.write().format("json").save("E:\\spark_resource\\goodStudentsDF");
